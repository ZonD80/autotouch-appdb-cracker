...
function fill_password() {
 ...
 // THIS ALSO INCLUDES HITTING "INSTALL" AFTER FILLING
 // PASSWORD.
...
function buy_crack_upload_app(trackid, request_id, bundle_id, server_url) {
    ...
    touchDown(11, 497.62, 376.06);
    usleep(16000);
    touchUp(11, 497.62, 376.06);

    usleep(10000000);
    log_and_toast("touching install..");
    touchDown(2, 794.53, 1189.69);
    usleep(16000);
    touchUp(2, 794.53, 1189.69);
    usleep(1000000);
...
function run() {
    ...
    var active_request = api_request('lol=lol','http://ENTER_SERVER_URL/active_request.json');
    ...
    server_url = 'http://ENTER_SERVER_URL/';
